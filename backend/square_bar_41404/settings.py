"""
Django settings for square_bar_41404 project.
...
ROOT_URLCONF = 'square_bar_41404.urls'
...
WSGI_APPLICATION = 'square_bar_41404.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "square_bar_41404 API",
    "DESCRIPTION": "API documentation for square_bar_41404 App",
    "VERSION": "v1",
}
